...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_4x6_5(KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_BSPC,
                             //-------------------------------------------------//-----------------------------------------------------------//
                             KC_ESC, KC_MINS, KC_COMM, KC_DOT, KC_P, KC_Y, KC_F, KC_G, KC_C, KC_R, KC_L, KC_BSPC,
                             //-------------------------------------------------//-----------------------------------------------------------//
                             KC_TAB, KC_A, KC_O, KC_E, KC_U, KC_I, KC_D, KC_H, KC_T, KC_N, KC_S, KC_SLSH,
                             //-------------------------------------------------//-----------------------------------------------------------//
                             KC_SCLN, KC_QUOT, KC_Q, KC_J, KC_K, KC_X, KC_B, KC_M, KC_W, KC_V, KC_Z, KC_LALT,
                             //-------------------------------------------------//-----------------------------------------------------------//
                             KC_LCTL, KC_LSFT, KC_SPC, KC_ENT, KC_ENT, KC_RGUI, KC_HOME, KC_BSPC, KC_RCTL, KC_RALT),
